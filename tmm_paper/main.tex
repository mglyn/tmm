...
\begin{tabular}{lcc}
\toprule
\textbf{Question Type} & \textbf{Mean Difficulty} & \textbf{\# Samples} \\
\midrule
...
Variance            & 5.0      & 100 \\
\midrule
\multicolumn{3}{l}{\small \textit{Overall 1,973 samples across 5 levels; distribution: 10.4\%/33.5\%/31.8\%/14.2\%/10.1\%.}} \\
\bottomrule
\end{tabular}
...
Beyond the scoring validity, the ordering itself matters.
In our ablation study (Table~\ref{tab:ablation}), removing difficulty ordering (the ``w/o Difficulty'' row) reduces ChartQA accuracy from 82.12\% to 80.84\%.
This 1.28-point drop is consistent and confirms that the easy-to-hard progression provided by \dacds{} contributes a reliable, non-trivial benefit to the curriculum structure.
