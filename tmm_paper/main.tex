...
\begin{figure*}[!t]
    \centering
    \subfloat[Ablation study]{\includegraphics[width=0.32\textwidth]{figures/fig3_ablation_study.png}\label{fig:exp_ablation}}
    \hfil
    \subfloat[Cross-model generalization]{\includegraphics[width=0.32\textwidth]{figures/fig5_multi_model_comparison.png}\label{fig:exp_models}}
    \hfil
    \subfloat[Cross-dataset transfer]{\includegraphics[width=0.32\textwidth]{figures/fig6_cross_dataset_evaluation.png}\label{fig:exp_transfer}}
